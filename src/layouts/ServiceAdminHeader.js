        ...
        <Container fluid>
          ...
          <Nav className="align-items-center d-md-none">
            <UncontrolledDropdown nav>
              ...
              <DropdownMenu className="dropdown-menu-arrow" right>
                ...
                <DropdownItem to="/serviceadmin/profile" tag={Link}>
                  {/* <Unicons.UilUserCircle size="20"/>
									<span>My profile</span> */}

                  <NavItem>
                    <NavLink href="/serviceadmin/profile">
                      <Unicons.UilUserCircle size="20" />
                      {/* <span>My profile</span> */}
                    </NavLink>
                  </NavItem>
          ...
          <Collapse navbar isOpen={navValues.collapseOpen}>
            ...
            <Nav className="mt-md-4 mb-md-3" navbar style={{ zIndex: "999" }}>
              <NavItem>
                <NavLink href="/serviceadmin/dashboard">
                  <Unicons.UilApps size="20" /> &nbsp; Dashboard
                </NavLink>
              </NavItem>

              <NavItem>
                <NavLink href="/serviceadmin/instructors">
                  <Unicons.UilUsersAlt size="20" /> &nbsp; Lecturers
                </NavLink>
              </NavItem>

              <NavItem>
                <NavLink href="/serviceadmin/courses">
                  <Unicons.UilBookAlt size="20" /> &nbsp; Courses
                </NavLink>
              </NavItem>

              <NavItem>
                <NavLink href="/serviceadmin/announcements">
                  <Unicons.UilMegaphone size="20" /> &nbsp; Announcements
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/serviceadmin/emailnotification">
                  <Unicons.UilEnvelopes size="20" /> &nbsp; Email Notifications
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/serviceadmin/profile">
                  <Unicons.UilUserCircle size="20" /> &nbsp; Profile
                </NavLink>
              </NavItem>

        ...
        <footer className="footer pt-6 bg-primary text-white">
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6">
              ...
              <span className="text-sentence font-weight-500">
                {" "}
                e-Learn FPA
              </span>

              <h3 className="mt-5 text-white">
                Online Learning the right way.
              </h3>

              <div className="socials my-4">
                <a
                  href="https://twitter.com/LLOYDANTBS"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/lloydant_ng/"
                  target="_blank"
                  className="text-white"
                >
            ...
            <div className="col-lg-6 d-flex justify-content-end foot-content">
              ...
              >
                ...
                <a
                  href="https://lloydant.com/Home/About"
                  target="_blank"
                  className="mb-3"
                >
                  About Us
                ...
                <a href="https://lloydant.com/Home/Contacts" className="mb-3">
                  Support{" "}
                </a>
              </div>
              ...
              <div className="d-flex flex-column">
                ...
                <a href="https://lloydant.com/Home/" className="mb-3">
                  Our Products{" "}
                </a>

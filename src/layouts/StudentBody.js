  ...
  return (
    <>
      <div className={props[stateKeys.PAGE_CLASS]}>
        <section
          className="sidenav-enabled pb-3 pb-md-4"
            ...
            <Suspense fallback={<p>Loading...</p>}>
              <div className="main-content pt-md-5">
                <Switch>
                  ...
                  />
                  <Route
                    path={"/student/livelectures"}
                    component={StudentLiveLectures}
                    exact={true}
                  />
                  <Route
                    path={"/student/emailnotification"}
        ...
        <p className="text-center copyright" style={{ fontSize: "14px" }}>
          Powered by <span className="text-success">TETfund</span>
        </p>
      </div>
    </>
  );

...
const InstructorHeader = (props) => {
  ...
  return (
    <>
      {/* <Navbar className="navbar-vertical fixed-left navbar-dark" style={{backgroundColor: "#440330"}} expand="md" id="sidenav-main" > */}
      <Navbar
            ...
            <Nav className="mt-md-4 mb-md-3" navbar style={{ zIndex: "999" }}>
              ...
              <NavItem>
                <NavLink href="/instructor/livelectures">
                  <Unicons.UilMeetingBoard size="20" /> &nbsp; Live Lectures
                </NavLink>
              </NavItem>
              ...
              <NavItem>
                <NavLink href="/instructor/materialbank">
                  <Unicons.UilMeetingBoard size="20" /> &nbsp; Material Store
                </NavLink>
              </NavItem>

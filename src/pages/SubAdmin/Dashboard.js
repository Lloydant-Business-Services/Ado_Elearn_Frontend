									...
									<div className="row no-gutters w-100 align-items-center">
										...
										<div className="col-12 col-lg-9">
											<div className="illustration-text p-3 m-1">
												<h2 className="illustration-text text-center text-lg-left my-auto">Hello Admin, Welcome Back</h2>
											</div>
										</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(SubAdminDashboard);
...
import StudentReport from "../../components/DataTables/StudentReportTable";
...
class ReportStudent extends Component {
  ...
  loadReport = (e) => {
    ...
    Endpoint.getDeptStudentsReport(reportProps).then((res) => {
      ...
      this.setState({ loadedStudents: tableData, mappedStudents: mappedData });
    });
  };
    ...
    return (
      <>
        ...
        <div className="container-fluid py-5">
          ...
          {this.state.currentReport ? (
            <StudentReport studentList={this.state.mappedStudents} />
          ) : null}
        </div>
      </>
    );

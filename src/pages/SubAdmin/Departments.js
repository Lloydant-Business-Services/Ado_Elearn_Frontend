...
class SchoolAdminDepartments extends Component {
  ...
  editDepartment = (e) => {
    ...
    if (
      this.state.editingDepartmentName === "" ||
      this.state.editingDepartment.name === this.state.editingDepartmentName
    ) {
  ...
  deleteDepartment = (e) => {
    ...
    Endpoint.deleteDepartment(deleteDepartmentProps).then((res) => {
      this.setState({
        error: false,
        success: true,
        deleteDepartmentLoading: false,
      ...
      .then((res) => {
        ...
        let mappedData = res.data.map((department, i) => {
          return {
            sNo: i + 1,
            departmentName: (
              <span searchvalue={department.name} className="capital">
                {department.name}
              </span>
            ),
  ...
  render() {
    return (
      <>
        ...
        <div className="container-fluid py-5">
          <div className="d-flex flex-wrap justify-content-between">
            <h1 className="mb-3 mr-2 text-primary my-auto">
              ...
              <span className="h2">{this.state.thisFaculty.name}</span> |
              Departments
            </h1>

            <button
              className="btn btn-primary"
              onClick={this.openNewDepartment}
            >
        ...
        <Modal
          isOpen={this.state.newDepartment}
          toggle={this.toggleNewDepartment}
          className="mt-5 md"
        >
          <form onSubmit={(e) => this.createDepartment(e)}>
                  ...
                  {this.state.newDepartmentFormIncomplete ? (
                    <div className="bg-danger border-rad-full text-center p-2 mb-3 custom-form-alert">
                      <p className="small text-white mb-0">
                        <Unicons.UilExclamationCircle size="20" /> Please enter
                        a department name.
                      </p>
                    </div>
                  ) : null}
            ...
            <ModalFooter>
              ...
              <button
                ...
                onClick={this.toggleNewDepartment}
              >
                Close
              </button>
            </ModalFooter>
        ...
        <Modal
          isOpen={this.state.editDepartment}
          toggle={this.toggleEditDepartment}
          className="mt-5 md"
        >
          <form onSubmit={(e) => this.editDepartment(e)}>
              ...
              <div className="form-group">
                ...
                <div className="custom-form-alert">
                  ...
                  {this.state.error ? (
                    <div className="bg-danger border-rad-full text-center p-2 mb-3">
                      <p className="small text-white mb-0">
                        <Unicons.UilExclamationCircle size="20" />{" "}
            ...
            <ModalFooter>
              ...
              <button
                type="button"
                className="btn btn-danger"
                onClick={this.toggleEditDepartment}
              >
                Close
              </button>
            </ModalFooter>
        ...
        <Modal
          isOpen={this.state.deleteDepartment}
          toggle={this.toggleDeleteDepartment}
          className="mt-5 md"
          size="sm"
        >
          <form onSubmit={(e) => this.deleteDepartment(e)}>
            ...
            <ModalBody>
              <div className="text-center">
                ...
                {this.state.deleteDepartmentFormIncomplete ? (
                  <div className="bg-danger border-rad-full text-center p-2 mb-3 custom-form-alert">
                    <p className="small text-white mb-0">
                      <Unicons.UilExclamationCircle size="20" /> Please select a
            ...
            <ModalFooter>
              ...
              <button
                type="button"
                className="btn btn-danger"
                onClick={this.toggleDeleteDepartment}
              >
                Close
              </button>
            </ModalFooter>

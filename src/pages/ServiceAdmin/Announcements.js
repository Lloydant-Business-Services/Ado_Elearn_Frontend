  ...
  render() {
    return (
      <>
        ...
        <div className="container-fluid py-5">
          <div className="d-flex flex-wrap justify-content-between">
            ...
            <div>
              <button
                ...
                onClick={this.openNewAnnouncement}
              >
          ...
          <div className="row mt-5">
            <div className="col-lg-9">
              {this.state.allAnnouncements &&
              this.state.allAnnouncements.length ? (
                      ...
                      <div className="d-flex">
                        <div className="flex-shrink-0">
                          <div className="px-3 py-1 bg-custom-light2 br-10">
                            <h4 className="text-custom mb-1">
                              <Unicons.UilEnvelopes size="25" />
                            </h4>
                          </div>
                        </div>

                        <div className="flex-grow-1 ml-3">
                          <h3 className="fw-500 text-custom fw-bold">
                            {announcement.title}
                          </h3>
        ...
        <Modal
          isOpen={this.state.newAnnouncement}
          toggle={this.toggleNewAnnouncement}
          className="mt-5 md"
        >
          <form onSubmit={(e) => this.createAnnouncement(e)}>
                  ...
                  {this.state.newAnnouncementFormIncomplete ? (
                    <div className="bg-danger border-rad-full text-center p-2 mt-3 mb-0">
                      <p className="small text-white mb-0">
                        <Unicons.UilExclamationCircle size="20" /> Please
                        provide an announcement title and content.
                      </p>
                    </div>
                  ) : null}
            ...
            <ModalFooter>
                ...
                {this.state.newAnnouncementLoading ? (
                  <span className="ml-2">
                    <ClipLoader
                      size={20}
                      color={"#fff"}
                      Loading={this.state.newAnnouncementLoading}
                    />
                  </span>
                ) : null}
              </button>
              ...
              <button
                ...
                onClick={this.toggleNewAnnouncement}
              >
                Close
              </button>
            </ModalFooter>

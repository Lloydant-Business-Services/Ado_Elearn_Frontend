        ...
        <div className="d-lg-flex half">
          <div className="bg order-1 order-md-2 login__bg">
            <div className="container p-top-30-vh">
              <h1
                style={{ color: "#FFF", fontSize: "4em", fontWeight: "bolder" }}
                ...
                <div className="col-md-7">
                  ...
                  <div className="mb-4">
                    ...
                    {this.state.buttomText ? (
                      <p className="mb-4">{this.state.buttomText}</p>
                    ) : null}
                  </div>
                    ...
                    <Fade>
                      <AttentionSeeker effect={"shake"} duration={300}>
                        <section>
                          ...
                          >
                            ...
                            <div className="form-group row justify-content-center">
                              <div className="col-md-12 text-left d-flex">
                                <button
                                  className="btn btn-primary mr-4 btn-arrow-right"
                                  type="submit"
                                >
                                ...
                                <p
                                  ...
                                  onClick={() =>
                                    this.resolveClickAction(FORGOT_PASSWORD)
                                  }
                                >
                                  Forgot password?
                                </p>
                          ...
                          >
                            Powered by{" "}
                            <span className="text-success">TETfund</span>
                          </p>
                        </section>
                      </AttentionSeeker>
                    </Fade>
                            ...
                            <div className="form-group row justify-content-center">
                              <div className="col-md-12 text-left d-flex">
                                ...
                                <p
                                  ...
                                  onClick={() => this.resolveClickAction(LOGIN)}
                                >
                                  <i className="fa fa-arrow-left" /> Login
                                </p>
                              </div>
                            </div>
                          </form>
                            ...
                            <div className="form-group row justify-content-center">
                              <div className="col-md-12 text-left d-flex">
                                <button
                                  className="btn btn-primary mr-4 btn-arrow-right"
                                  type="button"
                                  onClick={(e) => this.otpValidation(e)}
                                >
                                  Validate OTP

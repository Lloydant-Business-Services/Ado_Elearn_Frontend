                            ...
                            <div className={'row'}>
                                <div className={'col-lg-6'}>
                                    <div style={VertCenter}>
                                        ...
                                        <h2 className="fade-in two maitree display-4" style={{fontSize:"23px"}}>With e-Learn Federal Polytechnic Ado-Ekiti</h2>
                ...
                <div className="row justify-content-center">
                    ...
                    <div className="col-12 col-md-8 text-center">
                        ...
                        <p className="lead font-weight-400 mb-5" style={{fontSize:"17px"}}>
                            e-Learn FPA provides the best solution to online learning in Nigeria.
                            <br />
            ...
            <div className="bg-sky py-6">
                <div className="container">
                    ...
                    <p className="text-center">
                        The e-Learn FPA platform is used by some of the best institutions in the country.
                    </p>

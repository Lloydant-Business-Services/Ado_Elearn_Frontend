                ...
                <div className={"row"}>
                  <div className={"col-lg-6"}>
                    <div style={VertCenter}>
                      ...
                      <h2
                        className="fade-in two maitree display-4"
                        style={{ fontSize: "23px" }}
                      >
                        With e-Learn Federal Polytechnic ADO-EKITI
                      </h2>

                      <a
                        href="/login"
                        className="fade-in two btn btn-primary mt-3"
                      >
                        Get Started
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-8 text-center">
              ...
              <p
                className="lead font-weight-400 mb-5"
                style={{ fontSize: "17px" }}
              >
                e-Learn FPA provides the best solution to online learning
                in Nigeria.
                <br />
                Built for educational institutions looking to adopt an
                internet-based approach to learning,
                <br />
                e-Learn FPA is the all-in-one platform you need.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="card-body">
                  <div className="info text-left">
                    ...
                    <p className="description font-weight-400 opacity-8">
                      Set, take and review tests and exams online at your
                      convenience.
                    </p>
                  </div>
                </div>
              ...
              <div className="card card-lift--hover border border-primary cards-bg-tint">
                <div className="card-body">
                  <div className="info text-left">
                    ...
                    <p className="description font-weight-400 opacity-8">
                      Access your classes, materials and tutors anywhere, from
                      any device.
                    </p>
                  </div>
                </div>
              ...
              <div className="card card-lift--hover border border-primary cards-bg-tint">
                <div className="card-body">
                  <div className="info text-left">
                    ...
                    <p className="description font-weight-400 opacity-8">
                      Get summaries and details of all activities in your school
                      and classroom.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4">
                <div className="my-auto pt-5 text-center">
                  <h2 className="font-weight-bold mt-5">
                    Platform designed for real-life learning
                  </h2>
                  <p>
                    Move your education journey forward without putting life on
                    hold. eLearn NG helps you with learning that fits your
                    routine.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-sky py-6">
          <div className="container">
            ...
            <p className="text-center">
              The e-Learn FPA platform is used by some of the best
